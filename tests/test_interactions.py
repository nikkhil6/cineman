...
class TestMovieInteractions(unittest.TestCase):
    ...
    def test_dislike_movie(self):
        ...
        with self.client as client:
            ...
            response = client.post(
                "/api/interaction",
                json={"movie_title": "Inception", "action": "dislike", "value": True},
            )
    ...
    def test_get_watchlist(self):
        ...
        with self.client as client:
            ...
            client.post(
                "/api/interaction",
                json={"movie_title": "Inception", "action": "watchlist", "value": True},
            )
            client.post(
                "/api/interaction",
                json={
    ...
    def test_like_removes_dislike(self):
        ...
        with self.client as client:
            ...
            response = client.post(
                "/api/interaction",
                json={"movie_title": "Inception", "action": "like", "value": True},
            )
    ...
    def test_missing_required_fields(self):
        ...
        with self.client as client:
            ...
            response = client.post(
                "/api/interaction", json={"action": "like", "value": True}
            )
