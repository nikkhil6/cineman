...
if not os.getenv("OMDB_API_KEY"):
    print("❌ ERROR: OMDB_API_KEY environment variable is missing. Please set it before running.")
    sys.exit(1)
...
try:
    ...
    print("❌ FATAL: Could not import fetch_omdb_data_core. Ensure cineman package is installed.")
    sys.exit(1)
